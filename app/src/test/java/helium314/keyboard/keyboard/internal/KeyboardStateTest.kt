...
class KeyboardStateTest {
    ...
    @Test
    fun rapidDoubleShiftTapDoesNotCapsLock() {
        load()
    ...
    @Test
    fun shiftTapDisablesAutomaticSentenceCaps() {
        load()
    ...
    @Test
    fun capsLockRequiresCapsLockKeyPath() {
        load()
    ...
    private fun typeLetter(letter: Char) {
        state.onPressKey(letter.code, true, Constants.TextUtils.CAP_MODE_OFF, null)
