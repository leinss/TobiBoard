...
object KeyCode {
    ...
    const val ADD_TO_DICTIONARY =         -10052 // add the current selection / word at cursor to the personal dictionary
    ...
    fun Int.checkAndConvertCode(): Int = if (this > 0) this else when (this) {
        ...
        VOICE_INPUT, VOICE_STT_INPUT, TEXT_FIX, TEXT_FIX_2, LANGUAGE_SWITCH, SETTINGS, DELETE, ALPHA, SYMBOL, EMOJI, CLIPBOARD, CLIPBOARD_CUT, UNDO,
        ...
        SEND_INTENT_THREE, EMOJI_SEARCH, INLINE_EMOJI_SEARCH_DONE, META_LOCK, ADD_TO_DICTIONARY
        -> this
